				...
				<div className='mt-24 grid grid-cols-1 md:grid-cols-2 gap-10'>
					<div className=''>
						...
						<p className='p text-gray-600 mt-6'>
							At Therapy Supervision Dublin, our mission is to provide expert
							guidance and support to therapists as they grow and develop in
							their practices. We believe that through the supportive process of
							supervision, therapists can improve their skills, enhance their
							knowledge, and better serve their clients.
						</p>
						<p className='p text-gray-600 mt-6'>
							Our team is dedicated to fostering a safe and supportive
							environment where therapists can feel comfortable exploring their
							clinical work and challenges. We strive to create an atmosphere
							that promotes growth, learning, and self-care for therapists, so
							that they can be their best selves and provide the highest level
